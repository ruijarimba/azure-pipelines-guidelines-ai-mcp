...
| Next up | Monitor the companion manifest for new `ADOG-*` rules and preserve MCP output-safety coverage when adding rules |
...
1. **Monitor MCP output safety.** Preserve the shared diagnostic sanitizer and adversarial
