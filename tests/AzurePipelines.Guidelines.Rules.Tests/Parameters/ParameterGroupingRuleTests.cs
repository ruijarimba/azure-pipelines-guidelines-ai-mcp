...
public sealed class ParameterGroupingRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Parameters/ParameterGrouping/SensitiveParameter.yml");
    ...
    {
        string yaml = TestFixtures.Load("Parameters/ParameterGrouping/NonSensitiveParameter.yml");
