...
namespace AzurePipelines.Guidelines.Rules.Tests.Parameters;
...
public sealed class ParameterMissingValuesRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Parameters/ParameterMissingValues/WithoutValues.yml");
    ...
    {
        string yaml = TestFixtures.Load("Parameters/ParameterMissingValues/WithValues.yml");
    ...
    {
        string yaml = TestFixtures.Load("Parameters/ParameterMissingValues/NonStringType.yml");
    ...
    {
        string yaml = TestFixtures.Load("Parameters/ParameterMissingValues/ImplicitStringType.yml");
