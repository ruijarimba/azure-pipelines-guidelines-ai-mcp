...
public sealed class StepMissingTimeoutRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Steps/StepMissingTimeout/TaskWithoutTimeout.yml");
    ...
    {
        string yaml = TestFixtures.Load("Steps/StepMissingTimeout/TaskWithDisplayNameNoTimeout.yml");
    ...
    {
        string yaml = TestFixtures.Load("Steps/StepMissingTimeout/TaskWithTimeout.yml");
    ...
    {
        string yaml = TestFixtures.Load("Steps/StepMissingTimeout/ScriptStepNoTimeout.yml");
