...
public sealed class ServiceConnectionAuthRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Steps/ServiceConnectionAuth/WithoutServiceConnection.yml");
    ...
    {
        string yaml = TestFixtures.Load("Steps/ServiceConnectionAuth/WithServiceConnection.yml");
