...
public sealed class SecretLikeVariableRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Variables/SecretLikeVariable/WithSecretLikeName.yml");
    ...
    {
        string yaml = TestFixtures.Load("Variables/SecretLikeVariable/WithMappingStyleSecretName.yml");
    ...
    {
        string yaml = TestFixtures.Load("Variables/SecretLikeVariable/WithSafeName.yml");
