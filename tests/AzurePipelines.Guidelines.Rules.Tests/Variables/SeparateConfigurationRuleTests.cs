...
public sealed class SeparateConfigurationRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Variables/SeparateConfiguration/WithEmbeddedConfiguration.yml");
    ...
    {
        string yaml = TestFixtures.Load("Variables/SeparateConfiguration/WithVariableTemplate.yml");
