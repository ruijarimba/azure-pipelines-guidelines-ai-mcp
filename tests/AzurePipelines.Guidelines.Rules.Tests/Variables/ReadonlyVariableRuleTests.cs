...
public sealed class ReadonlyVariableRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Variables/ReadonlyVariable/MutableVariable.yml");
    ...
    {
        string yaml = TestFixtures.Load("Variables/ReadonlyVariable/ReadonlyVariable.yml");
