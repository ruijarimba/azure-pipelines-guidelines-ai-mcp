...
public sealed class SingleResponsibilityJobRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Jobs/SingleResponsibility/WithMultipleResponsibilities.yml");
    ...
    {
        string yaml = TestFixtures.Load("Jobs/SingleResponsibility/WithSingleResponsibility.yml");
