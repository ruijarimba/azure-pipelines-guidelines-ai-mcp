...
public sealed class JobMissingTimeoutRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Jobs/JobMissingTimeout/WithoutTimeout.yml");
    ...
    {
        string yaml = TestFixtures.Load("Jobs/JobMissingTimeout/MultipleJobsMixedTimeout.yml");
    ...
    {
        string yaml = TestFixtures.Load("Jobs/JobMissingTimeout/WithTimeout.yml");
