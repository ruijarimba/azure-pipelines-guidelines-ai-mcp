...
public sealed class EnvironmentParameterMinimizationRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Jobs/EnvironmentParameterMinimization/WithEnvironmentParameters.yml");
    ...
    {
        string yaml = TestFixtures.Load("Jobs/EnvironmentParameterMinimization/WithVariableTemplates.yml");
