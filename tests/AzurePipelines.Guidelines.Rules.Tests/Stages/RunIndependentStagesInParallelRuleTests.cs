...
/// <summary>Tests detection of independent stages that should run in parallel.</summary>
public sealed class RunIndependentStagesInParallelRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("Stages/RunIndependentStagesInParallel/WithoutDependsOn.yml");
    ...
    {
        string yaml = TestFixtures.Load("Stages/RunIndependentStagesInParallel/WithDependsOn.yml");
