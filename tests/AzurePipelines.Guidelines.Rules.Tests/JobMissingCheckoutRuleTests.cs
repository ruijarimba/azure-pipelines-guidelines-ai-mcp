...
public sealed class JobMissingCheckoutRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("JobMissingCheckout/WithoutCheckout.yml");
    ...
    {
        string yaml = TestFixtures.Load("JobMissingCheckout/WithCheckout.yml");
    ...
    {
        string yaml = TestFixtures.Load("JobMissingCheckout/WithCheckoutNone.yml");
