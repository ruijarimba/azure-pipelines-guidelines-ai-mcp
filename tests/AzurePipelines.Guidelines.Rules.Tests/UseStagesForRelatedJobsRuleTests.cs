...
public sealed class UseStagesForRelatedJobsRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("UseStagesForRelatedJobs/MultipleTopLevelJobs.yml");
    ...
    {
        string yaml = TestFixtures.Load("UseStagesForRelatedJobs/SingleTopLevelJob.yml");
