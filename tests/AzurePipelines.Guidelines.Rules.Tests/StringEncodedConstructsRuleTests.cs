...
public sealed class StringEncodedConstructsRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("StringEncodedConstructs/InlineJsonStyleValue.yml");
    ...
    {
        string yaml = TestFixtures.Load("StringEncodedConstructs/NativeYamlConstructs.yml");
