...
public sealed class MultiEnvironmentVariableTemplateRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("MultiEnvironmentVariableTemplate/MultiEnvironment.yml");
    ...
    {
        string yaml = TestFixtures.Load("MultiEnvironmentVariableTemplate/SingleEnvironment.yml");
