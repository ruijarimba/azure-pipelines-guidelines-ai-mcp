...
public sealed class RelativeTemplatePathRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("General/RelativeTemplatePath/WithRelativePath.yml");
    ...
    {
        string yaml = TestFixtures.Load("General/RelativeTemplatePath/WithAbsolutePath.yml");
