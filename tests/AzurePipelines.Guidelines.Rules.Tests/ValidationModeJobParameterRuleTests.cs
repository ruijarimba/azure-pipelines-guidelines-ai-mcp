...
public sealed class ValidationModeJobParameterRuleTests
{
    ...
    {
        // Arrange
        string yaml = TestFixtures.Load("ValidationModeJobParameter/WithoutValidationParameter.yml");
    ...
    {
        // Arrange
        string yaml = TestFixtures.Load("ValidationModeJobParameter/WithValidationParameter.yml");
