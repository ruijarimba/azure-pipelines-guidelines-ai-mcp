...
public sealed class MultipleStepsTemplatesInJobRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("MultipleStepsTemplatesInJob/MultipleTemplates.yml");
    ...
    {
        string yaml = TestFixtures.Load("MultipleStepsTemplatesInJob/SingleTemplate.yml");
