...
public sealed class TaskEnvironmentVariablesRuleTests
{
    ...
    {
        string yaml = TestFixtures.Load("TaskEnvironmentVariables/UsesVariablesWithoutEnv.yml");
    ...
    {
        string yaml = TestFixtures.Load("TaskEnvironmentVariables/UsesVariablesWithEnv.yml");
